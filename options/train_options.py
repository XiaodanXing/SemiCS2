...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--load_pretrain', type=str,
                                 default='',
        ...
        self.parser.add_argument('--no_ganFeat_loss', action='store_true', default=True, help='if specified, do *not* use discriminator feature matching loss')
        self.parser.add_argument('--no_vgg_loss', action='store_true',default=False,help='if specified, do *not* use VGG feature matching loss')
